...
const Navbar = () => {
  ...
  return (
    <div className="navbar_container">
     <div style={{display:'flex',width:'50%'}} className="first">
     <div className="logoContainer" onClick={()=>navigate("/")}>
        <svg
          ...
          width="156"
          height="36"
          class="sc-jrcTuL gsppgw Icon-sc-1iwi4w1-0 cZPTbN redirectCursor"
        >
          <path
      ...
      <div className="otherItems_nav" style={{display:'flex',justifyContent:'space-evenly',alignItems:'center'}}>
        <div className="redirectCursor downloadPara" >
          <img src={mobileImg} alt="" style={{width:'17px',margin:'0 8px 0 0'}}/>
          <span style={{fontSize:'17px',fontWeight:'bold'}}>Download App</span>
        </div>
        <div className="supplier">
          <span className="redirectCursor " style={{fontSize:'17px',fontWeight:'bold'}}>Become a Supplier</span>
        </div>
        <div className="redirectCursor lessSpacing" style={{display:'flex',flexDirection:'column',alignItems:'center'}} onClick={()=>navigate("/signup")}>
          <img src={userImg} alt="" style={{width:'20px'}}/>
          <span style={{fontSize:'17px',fontWeight:'bold'}}>Profile</span>
        </div>
        <div className="redirectCursor lessSpacing" style={{display:'flex',flexDirection:'column',alignItems:'center'}} onClick={()=>navigate("/cart")}>
          <img src={cartImg} alt="" style={{width:'22px'}}/>
          <span style={{fontSize:'17px',fontWeight:'bold'}}>Cart</span>
        </div>
      </div>
    </div>
  );
